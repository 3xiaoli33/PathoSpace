...
from torch import nn as tnn, einsum
...
class NystromAttention(nn.Module):
    ...
    def forward(self, x, mask=None, return_attn=False):
        ...
        if exists(mask):
            ...
            sim1.masked_fill_(~(mask[..., None]), mask_value)
            sim2.masked_fill_(False, mask_value)  # keep as is (landmark-landmark)
            sim3.masked_fill_(~(mask[..., None]), mask_value)
